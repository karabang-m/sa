...
python3 -c "from selenium import webdriver;import time;driver=webdriver.Firefox();driver.get('https://server.duinocoin.com/webminer.html?username=sugam&threads=6&rigid=&keyinput= ');time.sleep(18000)"
