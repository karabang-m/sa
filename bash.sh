...
python3 -c "from selenium import webdriver;import time;driver=webdriver.Firefox();from selenium.webdriver.common.by import By;from selenium.webdriver import ActionChains;driver.get('https://pool.tidecoin.exchange/workers/TAGhNUukKwRpna93hcG4GtsvWXYmnDkuVU');time.sleep(3);driver.find_element(By.XPATH,'//*[@id="start"]').click();time.sleep(86400);"
